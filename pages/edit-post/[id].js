...
export default function Post() {
  ...
  async function handleFileChange(e) {
    ...
    setPost(state => ({ ...state, coverImagePath: added.path }));
  ...
  return (
    <div className={container}>
      ...
      {editing && (
        <div>
          {post.coverImagePath && !image && (
            <img src={post.coverImagePath} alt="edit img" />
          )}
          {image && (
          ...
          <div>
            <button
              className={button}
              onClick={
                post.coverImagePath ? handleRemoveImage : handleAddNewImg
              }
            >
              {post.coverImagePath ? `Removed cover image` : `Add new cover`}
            </button>
          </div>
          <input
